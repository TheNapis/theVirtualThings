...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.createAndRunButton = QtWidgets.QPushButton(self.centralwidget)
        self.createAndRunButton.setGeometry(QtCore.QRect(390, 440, 141, 34))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.createAndRunButton.setText(_translate("MainWindow", "Create and run now"))
